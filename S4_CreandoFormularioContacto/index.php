...
//         FILTER_SANITIZE_STRING -> deprecated
	...
	if (!empty($mensaje)) {
		// Podemos sanear la cadena de texto con filter_var, pero queremos que en el
        // mensaje los signos se conviertan en entidades HTML
        // evitamos que el usuario inyecte codigo
...
// Comprobamos si hay errores, si no hay entonces enviamos.
	if (!$errores) {
		$enviar_a = 'firthunsps@gmail.com';
		$asunto = 'Correo enviado desde miPagina.com';
		$mensaje = "De: $nombre \n";
		$mensaje.= "Correo: $correo \n";
		$mensaje.= 'Mensaje: ' . $_POST['mensaje'];

		 mail($enviar_a, $asunto, $mensaje); // para que funciones tendría que subirlo a un hosting
		$enviado = 'true';
	}
}
